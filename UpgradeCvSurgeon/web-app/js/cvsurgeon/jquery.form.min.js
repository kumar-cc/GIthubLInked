...
(function (e) {
    ...
    function r(t) {
        ...
        var s = this;
        s.clk = n;
        if (n.type == "image")if (t.offsetX !== undefined) {
            s.clk_x = t.offsetX;
            s.clk_y = t.offsetY
    ...
    e.fn.ajaxSubmit = function (n) {
        ...
        function N(t) {
            var i = new FormData;
            for (var s = 0; s < t.length; s++)i.append(t[s].name, t[s].value);
            if (n.extraData) {
                var o = T(n.extraData);
                for (s = 0; s < o.length; s++)o[s] && i.append(o[s][0], o[s][1])
            }
            n.data = null;
        ...
        function C(t) {
            ...
            function k() {
                ...
                var a = [];
                try {
                    if (f.extraData)for (var l in f.extraData)f.extraData.hasOwnProperty(l) && (e.isPlainObject(f.extraData[l]) && f.extraData[l].hasOwnProperty("name") && f.extraData[l].hasOwnProperty("value") ? a.push(e('<input type="hidden" name="' + f.extraData[l].name + '">').val(f.extraData[l].value).appendTo(s)[0]) : a.push(e('<input type="hidden" name="' + l + '">').val(f.extraData[l]).appendTo(s)[0]));
                    if (!f.iframeTarget) {
                        p.appendTo("body");
            ...
            function _(t) {
                ...
                if (!A || A.location.href == f.iframeSrc)if (!y)return;
                ...
                try {
                    ...
                    } else a == "xml" && !v.responseXML && v.responseText && (v.responseXML = D(v.responseText));
                    try {
                        L = H(v, a, f)
                    } catch (t) {
                        r = "parsererror";
