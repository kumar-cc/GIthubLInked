    ...
    Croppic.prototype = {
                ...
                $.ajax({
                    ...
                    type: 'POST'
                        ...
                        if(response.status=='error'){
                            notificationAlert('Error',response.message)
                ...
                type: 'POST'
                    ...
                    if(response.status=='success'){
                        ...
                        if(that.options.outputUrlId !== ''){
                                       $('#'+that.options.outputUrlId).html('<img src='+response.url+'>');


                            $('#uploadButton').html('Change');
        ...
        reset:function(){
            ...
            if( !$.isEmptyObject(that.croppedImg)){
                ...
                if(that.options.outputUrlId !== ''){	$('#'+that.options.outputUrlId).val('<img src='+that.croppedImg.attr('url')+'>' );	}
            }
